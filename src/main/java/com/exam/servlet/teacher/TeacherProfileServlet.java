...
public class TeacherProfileServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        // 转发到个人设置页面
        request.getRequestDispatcher("/teacher/teacher_profile.jsp")
    ...
    private void updateProfile(HttpServletRequest request, HttpServletResponse response, User user)
        ...
        if (success) {
            ...
            response.sendRedirect(request.getContextPath() + "/teacher/profile?success=profile");
        } else {
    ...
    private void changePassword(HttpServletRequest request, HttpServletResponse response, User user)
        ...
        if (success) {
            response.sendRedirect(request.getContextPath() + "/teacher/profile?success=password");
        } else {
