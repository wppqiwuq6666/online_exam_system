...
<body>
    ...
    <div class="main-container">
        <!-- 返回按钮 -->
        <a href="${pageContext.request.contextPath}/admin/class/list" class="btn-back">
            <i class="bi bi-arrow-left me-2"></i>返回班级列表
        </a>
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                ...
                <h1 class="form-title">添加新班级</h1>
                <p class="form-subtitle">填写班级基本信息，创建新的班级档案</p>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/admin/class/add" method="post">
                ...
                <div class="form-floating-custom">
                    <input type="text"
                           name="grade"
                           class="form-input"
                           placeholder="请输入年级（如：一年级、2024级）"
                           required />
                    <i class="bi bi-bar-chart input-icon"></i>
                </div>
                ...
                <div class="form-floating-custom">
                    <textarea name="description"
                              class="form-input"
                              placeholder="请输入班级描述（可选）"></textarea>
                    <i class="bi bi-info-circle input-icon"></i>
                </div>

                <!-- 提交按钮 -->
                <button type="submit" class="btn-submit">
                    <i class="bi bi-check-circle me-2"></i>创建班级
                </button>
            </form>
        </div>
    </div>
