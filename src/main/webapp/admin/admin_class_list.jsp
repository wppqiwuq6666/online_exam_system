...
<%@ page import="java.util.*,com.exam.entity.Class" %>
<%
    List<Class> classes = (List<Class>) request.getAttribute("classes");
    Integer classCount = (Integer) request.getAttribute("classCount");
    ...
    <div class="main-container">
        ...
        <div class="page-banner">
            <div class="page-content">
                <h1 class="page-title">
                    <i class="bi bi-building me-3"></i>班级管理
                </h1>
                <p class="page-subtitle">管理所有班级信息，包括班级创建、编辑和删除</p>
            </div>
        </div>
        ...
        <div class="stats-row">
            <div class="stat-card">
                <div class="stat-number"><%=classCount != null ? classCount : 0%></div>
        ...
        <div class="control-bar">
            <div class="row align-items-center">
                <div class="col-md-6">
                    <form method="get" action="${pageContext.request.contextPath}/admin/class/list">
                        <div class="search-box">
                            <i class="bi bi-search"></i>
                            <input type="text" name="search" value="<%=searchKeyword != null ? searchKeyword : ""%>"
                                   placeholder="搜索班级名称或年级..." class="form-control">
                        </div>
                    </form>
                </div>
                <div class="col-md-6 text-end">
                    <a href="${pageContext.request.contextPath}/admin/class/add" class="btn-add-class">
                        <i class="bi bi-plus-circle me-2"></i>添加班级
                    </a>
                </div>
            </div>
        </div>
            ...
            <div class="class-grid">
                <% for(Class c : classes) { %>
                    <div class="class-card">
                        ...
                        <h3 class="class-name"><%=c.getClassName()%></h3>
                        <div class="class-grade">
                            <i class="bi bi-bar-chart me-1"></i><%=c.getGrade()%>年级
                        </div>
                        <div class="class-info">
                            <i class="bi bi-person me-1"></i>班主任：<%=c.getTeacherName() != null && !c.getTeacherName().isEmpty() ? c.getTeacherName() : "未分配"%>
                        </div>
                        <div class="class-info">
                            <i class="bi bi-people me-1"></i>学生人数：<%=c.getStudentCount()%>人
                        </div>
                        ...
                        <div class="action-buttons">
                            <a href="delete?id=<%=c.getId()%>"
                               ...
                               onclick="return confirm('确定要删除班级 \"<%=c.getClassName()%>\" 吗？')">
