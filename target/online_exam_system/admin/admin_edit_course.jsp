...
<%@ page import="com.exam.entity.Course" %>
<%
    // 检查课程信息是否存在
...
<body>
    ...
    <div class="main-container">
        ...
        <div class="form-container">
            ...
            <div class="form-header">
                ...
                <h1 class="form-title">编辑课程</h1>
                <p class="form-subtitle">修改课程信息，更新课程档案</p>
            </div>
            ...
            <form action="${pageContext.request.contextPath}/admin/course/edit" method="post">
                ...
                <div class="form-floating-custom">
                    <input type="text"
                           ...
                           value="<%=course.getTeacherName() != null ? course.getTeacherName() : ""%>" />
                ...
                <div class="form-floating-custom">
                    <select name="semester" class="form-input" required>
                        ...
                        <option value="2024年春季学期" <%= "2024年春季学期".equals(course.getSemester()) ? "selected" : "" %>>2024年春季学期</option>
                        <option value="2024年秋季学期" <%= "2024年秋季学期".equals(course.getSemester()) ? "selected" : "" %>>2024年秋季学期</option>
                        <option value="2025年春季学期" <%= "2025年春季学期".equals(course.getSemester()) ? "selected" : "" %>>2025年春季学期</option>
                        <option value="2025年秋季学期" <%= "2025年秋季学期".equals(course.getSemester()) ? "selected" : "" %>>2025年秋季学期</option>
                    </select>
                ...
                <div class="form-floating-custom">
                    <select name="status" class="form-input">
                        <option value="active" <%= "active".equals(course.getStatus()) ? "selected" : "" %>>开课中</option>
                        <option value="inactive" <%= "inactive".equals(course.getStatus()) ? "selected" : "" %>>已停用</option>
                    </select>
                ...
                <div class="form-floating-custom">
                    <textarea name="description"
                              class="form-input"
                              placeholder="请输入课程描述（可选）"><%=course.getDescription() != null ? course.getDescription() : ""%></textarea>
                    <i class="bi bi-info-circle input-icon"></i>
                </div>

                <!-- 提交按钮 -->
                <button type="submit" class="btn-submit">
                    <i class="bi bi-check-circle me-2"></i>更新课程
                </button>
            </form>
        </div>
    </div>
    ...
    <script>
        ...
        document.querySelector('form').addEventListener('submit', function() {
            ...
            btn.innerHTML = '<i class="bi bi-hourglass-split me-2"></i>正在更新...';
            btn.disabled = true;
